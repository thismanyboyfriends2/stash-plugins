...
| **Performer URL Aliases** | Extracts usernames from performer social media URLs (OnlyFans, X/Twitter, Instagram, Fansly) and adds them as aliases. Case-insensitive deduplication against existing aliases. |
